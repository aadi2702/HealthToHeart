...
export default function Contact() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.send('service_jv1yiog', 'template_kq4wolv', templateParams)
      .then((response) => {
                ...
                {formStatus === "success" ? (
                  ...
                  <div className="text-center py-12">
                    ...
                    <button
                      ...
                      className="mt-6 inline-flex items-center justify-center px-6 py-2 border border-transparent text-base font-medium rounded-lg text-white bg-teal-600 hover:bg-teal-700 shadow-md hover:shadow-lg transition-all duration-300"
                    >
                      Try Again
                    </button>
                  </div>
